...
from ntm import NTM
from ntm.datasets import CopyDataset, RepeatCopyDataset, AssociativeDataset, NGram, PrioritySort, Arithmetic
...
args.saved_model = 'saved_model_arithmetic_1m.pt'
cur_dir = os.getcwd()
PATH = os.path.join(cur_dir, 'Saved_Models')

PATH_sl = os.path.join(PATH, 'saved_losses_arithmetic_1m.csv')
